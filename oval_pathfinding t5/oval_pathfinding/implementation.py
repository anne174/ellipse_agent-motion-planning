...
class GridWithWeights(SquareGrid):
    ...
    def cost(self, from_node: GridLocation, to_node: GridLocation) -> float:
        ...
        # 判断是否是斜向移动：
        # 如果横坐标变了(x1!=x2) 且 纵坐标也变了(y1!=y2)，说明是斜着走的
        if x1 != x2 and y1 != y2:
            return math.sqrt(2)  # 斜向代价
...
raw_walls = [
    ...
    (18, 12), (14, 13), (18, 13), (14, 14), (18, 14), (14, 15),
    (14, 16), (18, 16), (14, 17), (18, 17), (14, 18), (18, 18),
    (2, 12), (2, 13), (3, 14), (15, 5), (16, 4), (17, 6),
    (8, 16), (9, 17)
]
new_walls=[]
for (x,y) in raw_walls:
    for dx in range(2):
        for dy in range(2):
            new_x=x*2+dx
            new_y=y*2+dy
            new_walls.append((new_x,new_y))
diagram_20.walls=new_walls
